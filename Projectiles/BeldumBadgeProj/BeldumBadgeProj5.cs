...
{
    public class BeldumBadgeProj5 : ModProjectile
    {
        ...
        public override void OnSpawn(IEntitySource source)
        {
            ...
            {
                //找到BeldumBadgeProj1
                if (Main.projectile[i].active && Main.projectile[i].type == ModContent.ProjectileType<BeldumBadgeProj2>())
                {
            ...
            if (target != null)
            {
                ...
                if (AttackTimer >= 60)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromAI(),
                        ...
                        ModContent.ProjectileType<BeldumBadgeProj6>(), // 生成我们自己写的弹幕
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                int dustIndex = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height,
                    DustID.PurpleTorch, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 100, default(Color), 1.5f);
