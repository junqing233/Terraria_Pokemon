...
{
    public class BeldumBadgeProj6 : ModProjectile
    {
        ...
        public override void OnSpawn(IEntitySource source)
        {
            ...
            {
                // 找到GastlyBadgeProj4
                if (Main.projectile[i].active && Main.projectile[i].type == ModContent.ProjectileType<BeldumBadgeProj5>())
                {
        ...
        public override bool PreDraw(ref Microsoft.Xna.Framework.Color lightColor)
        {
            ...
            for (int i = 0; i < ProjectileID.Sets.TrailCacheLength[Type]; i++)
            {
                ...
                Main.EntitySpriteDraw(texture, oldcenter, rectangle, Color.Pink * factor * 0.8f,
                    Projectile.oldRot[i],
