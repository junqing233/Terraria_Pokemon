...
namespace Pokemon.Content.Ball
{
    public class UltraBall : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.useTime = 20;
            Item.shoot = ModContent.ProjectileType<UltraBallProj>();
            Item.shootSpeed = 14f;
    ...
    public class UltraBallProj : ModProjectile
    {
        public override string Texture => "Pokemon/Content/Ball/UltraBall";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                texture = ModContent.Request<Texture2D>("Pokemon/Content/Ball/UltraBallProj_").Value;
