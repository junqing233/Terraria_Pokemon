...
using Pokemon.Content.Weapons.Magic.Staff;
using Terraria;
...
namespace Pokemon.Content.Ball
{
    ...
    {
        public override string Texture => "Pokemon/Content/Ball/PokeBall";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                texture = ModContent.Request<Texture2D>("Pokemon/Content/Ball/PokeBallProj_").Value;
