...
namespace Pokemon.Content.Ball
{
    public class GreatBall : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.useTime = 20;
            Item.shoot = ModContent.ProjectileType<GreatBallProj>();
            Item.shootSpeed = 13f;
    ...
    public class GreatBallProj : ModProjectile
    {
        public override string Texture => "Pokemon/Content/Ball/GreatBall";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                texture = ModContent.Request<Texture2D>("Pokemon/Content/Ball/GreatBallProj_").Value;
